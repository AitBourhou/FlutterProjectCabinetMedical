...
class propoAppoi extends StatefulWidget{
  ...
  AppointmentUser appointmentsPropo ;
                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              appointmentsPropo.dateApp + '\n'
                              + appointmentsPropo.heure,
                              style: TextStyle(
                                  fontSize: 15,
                                  color: Colors.black87),
                            )
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(image: AssetImage('assets/images/'+appointmentsPropo.photo),fit: BoxFit.fill),
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      'Dr.'+ appointmentsPropo.name +' ' + appointmentsPropo.firstname ,
                        ...
                        child:  Row(
                          ...
                          children: <Widget>[
                            ...
                            RaisedButton(
                              ...
                              onPressed: () { _acceptAppointment(appointmentsPropo.id);},
                            ...
                            RaisedButton(
                              ...
                              child: Text("         Refuser             "),
                              onPressed: () { _refuseAppointment(appointmentsPropo.id);},
                            ),
                          ],
                        ),
