...
class AppointmentAccepted extends StatefulWidget{
  ...
  AppointmentAccepted({Key key,this.title,this.doctorAppointment,this.appointmentsAccept}): super(key: key);
  final String title;
  @override
  _AppointmentAcceptedState createState() => new  _AppointmentAcceptedState(appointmentsAccept,doctorAppointment);
...
Doctor doctorAppointment;
List<Appointment> appointmentsAccept;
_AppointmentAcceptedState(this.appointmentsAccept,this.doctorAppointment);
@override
    ...
    body: Container(
      child: Column(
        ...
        children: <Widget> [
          ...
          for(var appointment in appointmentsAccept)
            Expanded(
              flex: 3,
