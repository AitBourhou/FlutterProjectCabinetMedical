...
class AppointmentProgress extends StatefulWidget{
  ...
  AppointmentProgress({Key key,this.title,this.appointmentsRequest}): super(key: key);
  final String title;
  @override
  _AppointmentProgressState createState() => new  _AppointmentProgressState(appointmentsRequest);
...
List<AppointmentUser> appointmentsRequest;
_AppointmentProgressState(this.appointmentsRequest);
@override
