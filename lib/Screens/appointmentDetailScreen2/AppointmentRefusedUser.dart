...
class AppointmentRefused extends StatefulWidget{
  ...
  AppointmentRefused({Key key,this.title,this.appointmentsRefuse}): super(key: key);
  final String title;
  @override
  _AppointmentRefusedState createState() => new  _AppointmentRefusedState(appointmentsRefuse);
...
List<AppointmentUser> appointmentsRefuse;
_AppointmentRefusedState(this.appointmentsRefuse);
@override
